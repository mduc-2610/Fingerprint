...
function App() {
  const [activeModule, setActiveModule] = useState('employee-access');
  const [segmentationModelId, setSegmentationModelId] = useState(null);
  const [recognitionModelId, setRecognitionModelId] = useState(null);
  ...
  const renderModule = () => {
    switch (activeModule) {
      ...
      case 'register-fingerprint':
        return <RegisterFingerprint segmentationModelId={segmentationModelId} recognitionModelId={recognitionModelId} />;
      case 'recognize-fingerprint':
        return <RecognizeFingerprint segmentationModelId={segmentationModelId} recognitionModelId={recognitionModelId} />;
      case 'model-list':
        return <ModelList setSegmentationModelId={setSegmentationModelId} setRecognitionModelId={setRecognitionModelId} segmentationModelId={segmentationModelId} recognitionModelId={recognitionModelId} />;
  ...
  const modules = [
    ...
    { key: 'model-list', label: 'Quản lý mô hình' },
