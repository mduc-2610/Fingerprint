...
function loadModels() {
    ...
    fetch(`${BASE_MODEL_SERVICE}/fingerprint-segmentation-model`)
        .then(response => response.json())
        .then(data => {
    ...
    fetch(`${BASE_MODEL_SERVICE}/fingerprint-recognition-model`)
        .then(response => response.json())
        .then(data => {
...
function loadEmployees() {
    ...
    fetch(`${BASE_USER_SERVICE}/employee`)
        .then(response => response.json())
        .then(data => {
...
function setupRegisterForm() {
    document.getElementById('registerForm').addEventListener('submit', function(event) {
        ...
        fetch(`${BASE_BIOMETRICS_SERVICE}/fingerprint/register/${selectedEmployee.id}/single`, {
            method: 'POST',
            body: formData
        })
        .then(response => response.json())
